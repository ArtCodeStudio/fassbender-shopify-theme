...
gulp.task('scss', ['sass']);
gulp.task('sass', ['bootstrap_sass_test_build', 'sass-concat']);

// ALL THE TASKS!!! plus zipping up a fully built theme
gulp.task('build', ['sass', 'typescript', 'zip']);

// build sass to test build
// gulp.task('bootstrap_sass_test_build', ['sass-concat_test'], function () {
...
// // sass-concat_TEST: Pull our scss files together for tests
// gulp.task('sass-concat_test', ['bootstrap_theme_settings_scss'], function () {
