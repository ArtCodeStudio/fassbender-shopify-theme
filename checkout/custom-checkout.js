...
var start = function () {
  ...
  cc.texts.dataTransfer =
    "Ich bin damit einverstanden, dass meine E-Mail-Adresse bzw. meine Telefonnummer an <em>" +
    cc.texts.suppliers.ups +
    " und " +
    cc.texts.suppliers.other +
    "</em> weitergegeben wird, damit der Paketdienstleister vor der Zustellung der Ware zum Zwecke der Abstimmung eines Liefertermins per E-Mail oder Telefon Kontakt mit mir aufnehmen bzw. Statusinformationen zur Sendungszustellung übermitteln kann. Meine diesbezüglich erteilte Einwilligung kann ich jederzeit widerrufen.";
  cc.texts.legals =
    'Hiermit akzeptiere ich Ihre <a href="' +
    cc.urls.TermsOfService +
    '" target="_blank" title="AGB">AGB</a> sowie Ihre <a href="' +
    cc.urls.privacyPolicy +
    '" target="_blank" title="Datenschutzerklärung">Datenschutzerklärung</a>.';

  cc.errors = {};
  cc.errors.acceptLegals =
    'Bitte akzeptieren Sie unsere <a href="' +
    cc.urls.TermsOfService +
    '" target="_blank" title="AGB">AGB</a> und <a href="' +
    cc.urls.privacyPolicy +
    '" target="_blank" title="Datenschutzerklärung">Datenschutzerklärung</a>.<br><br>Bei Fragen zu unseren Kaufbedingungen kontaktieren Sie bitte unseren <a href="' +
    cc.urls.contact +
    '" target="_blank" title="Kundenservice">Kundenservice</a>.';
  cc.errors.acceptDataTransfer =
    'Bitte akzeptieren Sie unsere Nachrichtenübermittlung an den Paketdienstleister.<br><br>Bei Fragen zu unseren Kaufbedingungen kontaktieren Sie bitte unseren <a href="' +
    cc.urls.contact +
    '" target="_blank" title="Kundenservice">Kundenservice</a>.';
  ...
  cc.templates = {
    notes:
      ...
      cc.texts.legals +
      '<p class="field__message field__message--error" id="error-for-legals">' +
      cc.errors.acceptLegals +
      "</p>" +
      "</label>" +
      "</div>" +
      ...
      cc.texts.dataTransfer +
      '<p class="field__message field__message--error" id="error-for-data-transfer">' +
      cc.errors.acceptDataTransfer +
      "</p>" +
      "</label>" +
      "</div>" +
  ...
  cc.disableTrackingsIfCookieIsSet = function () {
    if (
      ...
      cc.cookieIsTrue(cc.theTradeDeskDisableStr)
    ) {
      cc.disableTheTradeDesk();
    }
    if (
      navigator.doNotTrack === "1" ||
      cc.cookieIsTrue(cc.facebookPixelDisableStr)
    ) {
    ...
    if (
      navigator.doNotTrack === "1" ||
      cc.cookieIsTrue(cc.pinteresstTagDisableStr)
    ) {
      cc.disableTheTradeDesk();
    }
  };
  ...
  cc.initTracking = function (cb) {
    ...
    if (cc.cookieIsTrue(cc.theTradeDeskDisableStr)) {
      ...
      cc.loadScript(
        "https://cdn.shopify.com/s/files/1/0075/8903/6147/files/up_loader.1.1.3.js?16684598101524282847",
        function () {
  ...
  cc.initAgbBox = function () {
    cc.loadJquery(function (error, $) {
      ...
      $('[data-trekkie-id="complete_order_button"]').on(
        "click",
        function (event) {
          ...
          if (
            $("#checkout_legals").is(":checked") &&
            $("#checkout_data_transfer_true").is(":checked")
          ) {
            error = false;
